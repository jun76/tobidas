...
3. 画像生成では作品全体のテイスト、縮尺、色、光の方向を固定し、地面、空間背景、立体パーツを別プロンプトで生成する。
4. 素材の透過、寸法、縦横比、容量、余白を確認する。
5. 開発サーバーを起動し、AIモードで素材をまとめて読み込む。
6. AIモードでは、配置前に対象見開きのツリー項目を選択する。
7. 地面、空間背景、立体パーツ、テキスト、パーティクルを見開きごとに配置し、名前、位置、寸法、レイヤー、表示状態を更新する。
8. AIモードで扱えない表紙、カメラ、光源、モーション、音声キューは通常モードまたは作品定義で設定する。
