...
<p align="center">
  <img alt="Release: 0.2.0" src="https://img.shields.io/badge/Release-0.2.0-5a68d8">
...
Canvas座標を推定しない配置には、部品プリセット見出しの「詳細配置（AI用）」を使います。
...
作品ごとの制作方針は、右側のインスペクター下にある「制作ガイド」ペインで表示言語ごとに確認・編集します。
